...
# Sortowanie malejąco i wybór TOP-K (dla czytelności)
TOP_K = 20  # zmień na None, jeśli chcesz pokazać wszystkie
xgb_importances_sorted = xgb_importances.sort_values(ascending=False)
to_plot = xgb_importances_sorted.head(TOP_K) if TOP_K else xgb_importances_sorted

# Rysowanie wykresu słupkowego (kolor ≠ niebieski)
plt.figure(figsize=(12, 6))
to_plot.plot(kind='bar', color='orange')  # dowolny inny kolor niż niebieski
...
print("Wykres zapisany jako: xgb_feature_importances.png")
